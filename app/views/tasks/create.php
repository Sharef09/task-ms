...
<div class="d-flex justify-content-between align-items-center mb-2">
    <h5 class="fw-bold mb-0"><i class="fas fa-plus-circle me-2"></i>Create New Task</h5>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form method="POST" action="<?= rtrim($app['url'], '/') ?>/tasks/store" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter task title" value="<?= e(old('title')) ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="category_id" name="category_id">
                        ...
                        <option value="<?= e($cat->id) ?>" <?= (old('category_id') == $cat->id) ? 'selected' : '' ?>><?= e($cat->name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="assigned_to" name="assigned_to">
                        ...
                        <option value="<?= e($user->id) ?>" <?= (old('assigned_to') == $user->id) ? 'selected' : '' ?>><?= e($user->first_name . ' ' . $user->last_name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="task_type" name="task_type" onchange="toggleAttachment(this)">
                        <option value="Normal" <?= old('task_type') === 'Normal' ? 'selected' : '' ?>>Normal</option>
                        <option value="File Attached" <?= old('task_type') === 'File Attached' ? 'selected' : '' ?>>File Attached</option>
                        <option value="Initiation" <?= old('task_type') === 'Initiation' ? 'selected' : '' ?>>Initiation</option>
                    </select>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" id="start_date" name="start_date" value="<?= e(old('start_date')) ?>">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" id="due_date" name="due_date" value="<?= e(old('due_date')) ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="estimated_hours" name="estimated_hours" placeholder="0" value="<?= e(old('estimated_hours')) ?>" min="0" step="0.5">
                    </div>
                </div>

                <div class="col-md-6" id="attachmentField" style="display:none;">
                    <label for="attachment" class="form-label small fw-medium">Attachment</label>
                    <input type="file" class="form-control" id="attachment" name="attachment">
                    <div class="form-text small">Upload file for this task.</div>
                </div>

                <div class="col-12">
                    <label for="description" class="form-label small fw-medium">Description</label>
                    <textarea class="form-control" id="description" name="description" rows="5" placeholder="Enter task description"><?= e(old('description')) ?></textarea>
                </div>
            </div>
            ...
            <div class="mt-4 pt-3 border-top">
                <button type="submit" class="btn btn-primary px-4"><i class="fas fa-plus me-1"></i>Create Task</button>
