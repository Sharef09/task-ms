...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-bold mb-0"><i class="fas fa-plus-circle me-2"></i>Create New Meeting</h5>
    <a href="<?= rtrim($app['url'], '/') ?>/meetings" class="btn btn-sm btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back</a>
</div>

<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form method="POST" action="<?= rtrim($app['url'], '/') ?>/meetings/store">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-8">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="status">
                        ...
                        <option value="<?= e($s) ?>" <?= old('status') === $s ? 'selected' : '' ?>><?= e($s) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="organizer_id">
                        ...
                        <option value="<?= e($u->id) ?>" <?= old('organizer_id') == $u->id ? 'selected' : '' ?>><?= e($u->first_name . ' ' . $u->last_name) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="datetime-local" class="form-control" name="start_date" value="<?= e(old('start_date')) ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label small fw-medium">End Date</label>
                    <input type="datetime-local" class="form-control" name="end_date" value="<?= e(old('end_date')) ?>">
                </div>
                <div class="col-12">
            ...
            <div class="mt-4 pt-3 border-top">
                <button type="submit" class="btn btn-primary px-4"><i class="fas fa-save me-1"></i>Create Meeting</button>
